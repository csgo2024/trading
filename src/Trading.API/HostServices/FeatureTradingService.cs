...
public class FeatureTradingService : BaseTradingService<Strategy>
{
    private readonly BinanceRestClient _binanceClient;
    private readonly IStrategyRepository _strategyRepository;

    public FeatureTradingService(ILogger<FeatureTradingService> logger,
        IStrategyRepository strategyRepository,
        BinanceRestClient binanceClient) : base(logger)
    {
    ...
    {
        return await _strategyRepository.InitializeFeatureStrategies();
    }
    ...
    {
        var exchangeInfo = await _binanceClient.UsdFuturesApi.ExchangeData.GetExchangeInfoAsync(ct);
